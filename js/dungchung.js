	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="index.html?search=iPhone"><i class="fa fa-mobile" aria-hidden="true"></i> Iphone</a></li>
                <li><a href="index.html?search=Samsung"><i class="fa fa-mobile" aria-hidden="true"></i> Samsung</a></li>
                <li><a href="index.html?search=Huawei"><i class="fa fa-mobile" aria-hidden="true"></i> Huawei</a></li>
                <li><a href="index.html?search=Oppo"><i class="fa fa-mobile" aria-hidden="true"></i> Oppo</a></li>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">TMT Phone Store</a> - All rights reserved © 2023 - Designed by
            <span style="color: #eee; font-weight: bold">Trịnh Minh Thế</span></p>
    </div>`);
}
